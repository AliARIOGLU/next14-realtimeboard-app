...
export const Canvas = ({ boardId }: CanvasProps) => {
  ...
  // protect you from larger screen teammate scroll/screen movement;
  ...
  const startMultiSelection = useCallback((current: Point, origin: Point) => {
    // for understand selection start
    // mouse'a basılı tutup oynattığını anlaman için bir threshold
    if (
      Math.abs(current.x - origin.x) + Math.abs(current.y - origin.y) >
      SELECTION_START_THRESHOLD
    ) {
  ...
  // if user mouse out of window mouse icon dissapear.
